...
public class BookJPA {
        ...
        public BookJPA(Long id, String isbn, String title, String author, Double price, String publisher, Instant createdDate, Instant lastModifiedDate, int version) {
                this.id = id;
                this.isbn = isbn;
                this.title = title;
                this.author = author;
        ...
        public static BookJPA of(String isbn, String title, String author, Double price, String publisher) {
                return new BookJPA(null, isbn, title, author, price, publisher, null, null, 0);
        }
