...
import com.sudarshan.catalogservice.config.DataConfig;
...
public class BookRepositoryJpaTests {
	...
	@Test
	void findAllBooks() {
		var book1 = BookJPA.of("1234561235", "Title", "Author", 12.90, "Polarsophia");
		var book2 = BookJPA.of("1234561236", "Another Title", "Author", 12.90, "Polarsophia");
		entityManager.persist(book1);
		entityManager.persist(book2);

		Iterable<BookJPA> actualBooks = bookRepository.findAll();
	...
	void findBookByIsbnWhenExisting() {
		...
		var book = BookJPA.of(bookIsbn, "Title", "Author", 12.90, "Polarsophia");
		entityManager.persist(book);

		Optional<BookJPA> actualBook = bookRepository.findByIsbn(bookIsbn);
	...
	void findBookByIsbnWhenNotExisting() {
		Optional<BookJPA> actualBook = bookRepository.findByIsbn("1234561238");
	...
	void existsByIsbnWhenExisting() {
		...
		var bookToCreate = BookJPA.of(bookIsbn, "Title", "Author", 12.90, "Polarsophia");
